...
```
cd existing_repo
git remote add origin https://gitlab.noveogroup.com/trainings-aluzgin/aluzgin-nodejs-training.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.noveogroup.com/trainings-aluzgin/aluzgin-nodejs-training/-/settings/integrations)
